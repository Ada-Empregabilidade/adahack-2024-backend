...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.createTable("Candidato", {
      ...
      identidade_genero: {
          type: Sequelize.ENUM("mulher cis", "homem cis", "mulher trans", "homem trans", "não-binário", "neutro", "agênero"),
          allowNull: false
      },
      orientacao_sexual: {
          type: Sequelize.ENUM("heterossexual", "homossexual", "bissexual", "assexual", "pansexual", "outro"),
          allowNull: false
      },
      pcd: {
